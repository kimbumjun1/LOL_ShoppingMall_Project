...
function DetailProductPage(props) {
    ...
    return (
        <div style={{ width: '100%', margin: '0 auto', padding:'3rem 0' }}> {/*padding: '3rem 4rem' padding:'8em 0'*/}
            ...
            <div style={{width:'70%', margin: '0 auto'}}>
                <br />
                <div>홈 > 시리즈 > {Product.title}</div> 
                <br />
                {/*L: 제품 사진 ,R: 제품 정보,가격  */}
                <div className='product_info_container' style={{display:'flex'}}>
                    <div className='product_img' style={{width:'60%', margin:'0 auto',  padding:'1em 1em'}}>
                        {/* <h2>사진 부분</h2> */}
                        {/* ProductImage */}
                ...
                {/* 제품 상세정보 */}
                <ProductMoreInfo detail={Product} />
