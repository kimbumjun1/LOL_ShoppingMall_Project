...
function CartPage(props) {
    ...
    return (
        <div style={{ width: '70%', margin: '4rem auto' }}> {/** 80% 3rem auto */}

            <h1 style={{fontWeight:'bold'}}>장바구니</h1>
            <div className='cart-container' style={{display:'flex'}}>
                
                <div className='cartblock-container' style={{width: '60%', marginRight:'1em', display:'flex', flexDirection:'column'}}>
                ...
                <div className='cart-info' style={{width:'40%'}}>
                    <div className='cart-info-summary' style={{marginBottom:'1em', padding:'0.5em 1em'}}>
                        ...
                        {/* <div style={{display:'flex', justifyContent:'space-between'}}>
                            <h4>주문품목 정가</h4><h4>원</h4>
                        </div> */}
                        <div style={{display:'flex', justifyContent:'space-between'}}>
                            <h4>배송비 </h4>{Total>70 ? <h4> 무료 </h4>: <h4>$ 3</h4>} {/* 합계 금액에 따라서 무료인지 아닌지 ? : 이용하기*/}
                        </div>
                        <div style={{display:'flex', justifyContent:'space-between'}}>
                            <h2>합계</h2><h2>$ {Total>100 ? Total : Total+3}</h2> {/* 배송비 포함 금액 나타내기 */}
                        </div>
                        {ShowTotal &&
                            <Paypal
                                total={Total}
